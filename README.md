...
* [Architect](http://www.openanalytics.eu/downloads/architect) - Bundle of [Eclipse](https://eclipse.org/) and [StatET](http://www.walware.de/goto/statet) that requires no extra installation of R, Architect comes with R preloaded.
